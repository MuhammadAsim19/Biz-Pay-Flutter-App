                      ...
                      CustomTextFieldWithOnTap(
                        ...
                        isBorderRequired:allFiles!=null && allFiles!.isNotEmpty? false:true,
                          prefixIcon: GestureDetector(
                              ...
                              onTap: () async {
                              final  List<PlatformFile>?  filesPicked = await PickFile.pickFiles();
...
///docs
    ...
    {
      print("in here");
      InboxControllers.chatDetailData.value.messages?.add(Message(id: widget.chatDto?.id,sender: "6579ea61d76f7a30f94f5c80",receiver: "6579f21c00996aa38f7c7a2b",images:[] ,videos: [],docs: [],content: message.text,createdAt: DateTime.now()));
    InboxControllers.chatDetailData.notifyListeners();
    }
    print("here");
    // const images = [
